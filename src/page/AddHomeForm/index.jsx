...
class AddHomeForm  extends Component{//继承Component
    constructor(props){
        super(props)//继承props
...
const mapStateToProps = (state) => {//值映射到props中
    return {
        pageData: state.pageData.AddHomeForm || false
    }
}
...
export default connect(mapStateToProps,mapDispatchToProps)(AddHomeForm)
